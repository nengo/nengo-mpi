...
from nengo.neurons import LIF, LIFRate, RectifiedLinear, Sigmoid, Direct
...
with warnings.catch_warnings():
    ...
    def build_ensemble(model, ens):
        if isinstance(ens.neuron_type, Direct):
            raise NotImplementedError(
                "direct-mode simulations not implemented in nengo_mpi.")

        return builder.build_ensemble(model, ens)

    builder.Builder.register(Ensemble)(
        make_builder(build_ensemble))
    ...
    builder.Builder.register(Network)(
        make_builder(build_network))
