...
nengo_mpi is an MPI backend for the
`Nengo <https://pythonhosted.org/nengo/index.html>`_ python library.
It permits running Nengo simulations spread over thousands of processors
communicating with one another at high speeds. Existing nengo scripts can
be adapted to take advantage of nengo_mpi with minimal effort.
...
There are 3 differences between this script and a script using Then
...
nengo_mpi is fully featured, supporting all aspects of Nengo Release 2.1.
